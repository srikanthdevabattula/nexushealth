    ...
    <div className="flex flex-col overflow-auto h-[80%] items-center justify-center xl:mt-6 mt-1  pb-10 text-center  ">
      <div className="mb-3">
        <div className=" rounded-full flex items-center justify-center text-3xl">
          <img src="/icons/robo.png" alt="" className="xl:w-[56px] lg:w-[45px] md:w-[40px] w-[25px] xl:h-[56px] lg:h-[45px] md:h-[40px] h-[25px]" />
        </div>

        <h2 className="xl:text-[24px] lg:text-[20px] md:text-[18px] text-[14px]  font-semibold">Welcome to AI Copilot</h2>
      ...
      <div className="grid grid-cols-2 lg:gap-3 gap-2 xl:mt-2 mt-1">
        {cards.map((card) => (
          ...
          >
            <img src={card.icon} className="w-[8px] lg:w-[15px] md:w-[13px] h-[10px] lg:h-[20px] md:h-[16px]"/>
            <h3 className="font-medium xl:text-[16px] lg:text-[15px] md:text-[13px] text-[10px] text-[#1D293D] my-1 ">{card.title}</h3>
            <p className="text-[#45556C] xl:text-[14px] lg:text-[13px] md:text-[10px] text-[7px] font-inter ">{card.desc}</p>
          </div>
        ))}
      </div>
<div className="w-[100%] flex justify-center items-center mt-6  fixed bottom-0 xl:h-[120px] lg:h-[100px] md:h-[80px] h-[60px] bg-white">
      <div className="lg:w-[78%] md:w-[70%] w-[95%]">
        ...
        />
        <img src="/icons/icon (9).png" alt="" className="xl:w-[40px] lg:w-[37px] md:w-[30px] w-[20px] xl:h-[40px] lg:h-[37px] md:h-[30px] h-[20px] mr-2"/>
        </div>

        <div className="flex items-center justify-between xl:text-[12px] lg:text-[11px] md:text-[10px] text-[6px] text-[#45556C] mt-2 px-1">
          <span className="flex items-center "><img src="/icons/shield.png" className="md:w-[16px] w-[10px] md:h-[16px] h-[10px] md:mr-1 mr-[2px]" alt="" />HIPAA Compliant <img src="/icons/lock.png" className="md:w-[12px] w-[7px] md:h-[17px] h-[10px] ml-2 md:mr-1 mr-[2px]" alt="" />End-to-End Encrypted</span>
          <span>Press Enter to send<span className="hidden md:inline">, Shift+Enter for new line</span></span>
        </div>
      </div>
      </div>
    </div>
